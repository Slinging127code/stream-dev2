package com.xy.dws.app;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.xy.bean.TradeProvinceOrderBean;
import com.xy.dws.fonction.BeanToJsonStrMapFunction;
import com.xy.dws.fonction.CustomStringDeserializationSchema;
import com.xy.dws.fonction.DimAsyncFunction;
import com.xy.util.DateFormatUtil;
import com.xy.util.FlinkSinkUtil;
...
public class DwsTradeProvinceOrderWindow{
    ...
    public static void main(String[] args) {
        ...
        KafkaSource<String> source = KafkaSource.<String>builder()
                ...
                .setTopics("dwd_trade_xinyi_jiao_detail")
                .setGroupId("my-group")
