...
/**
 * @Package com.bg.dwd.function.AgeScoreFunc
 * @Author  xinyi.jiao
 * @Date 2025/5/14 19:51
 * @description: 年龄标签计算总分
 */
public class AgeScoreFunc extends RichMapFunction<JSONObject,JSONObject> {
    ...
    public JSONObject map(JSONObject jsonObject) {
        ...
        String categoryName = age.getString("category1_name");
        //品牌
        ...
        if (ageGroup != null && ageGroup.equals("18-24")){
            ...
            ageScore.put("category_score", -1.000 );
        }
