...
//        hbaseUtils.dropHbaseNameSpace("ns_xinyi_jiao");
//        System.err.println(hbaseUtils.tableIsExists("ns_xinyi_jiao:dim_user_info"));
        hbaseUtils.getHbaseNameSpaceAllTablesList("ns_xinyi_jiao");
    }
}